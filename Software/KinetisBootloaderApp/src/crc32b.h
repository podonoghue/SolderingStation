...
public:
   ...
   /**
    * Initialise CRC calculation before chained calculations
    */
   void configure() {
      crcValue = 0xFFFFFFFF;
   }
    ...
    *
    * @note Assumes seed has been initialised (by constructor or configure())
    * @note Calculations may be chained
    */
