...
const GpioFieldTable_T<GpioCInfo, 2, 1, ActiveLow>           ch1Drive;                                     // PTC1(p44), PTC2(p45)
/// Channel 1 selected LED
const GpioTable_T<GpioCInfo, 0, ActiveHigh>                  ch1SelectedLed;                               // PTC0(p43)
...
void mapAllPins() {
   ...
   PORTA->GPCLR = ForceLockedPins|0x0000UL|PORT_GPCLR_GPWE(0x2000UL);
   ...
   PORTB->GPCHR = ForceLockedPins|0x0100UL|PORT_GPCHR_GPWE(0x000FUL);
