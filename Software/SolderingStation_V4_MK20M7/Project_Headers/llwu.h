...
enum LlwuPin : uint32_t {
   ...
   // Mapped pins
   LlwuPin_Pte1                                       = LlwuPin_0,    ///< Mapped pin PTE1(p2)
   LlwuPin_Pta4                                       = LlwuPin_3,    ///< Mapped pin PTA4(p26)
   LlwuPin_Ptb0                                       = LlwuPin_5,    ///< Mapped pin PTB0(p35)
   LlwuPin_Ptc1                                       = LlwuPin_6,    ///< Mapped pin PTC1(p44)
   LlwuPin_Ptc3                                       = LlwuPin_7,    ///< Mapped pin PTC3(p46)
   LlwuPin_Ptc4                                       = LlwuPin_8,    ///< Mapped pin PTC4(p49)
   LlwuPin_Ptc5                                       = LlwuPin_9,    ///< Mapped pin PTC5(p50)
   LlwuPin_Ptc6                                       = LlwuPin_10,   ///< Mapped pin PTC6(p51)
   LlwuPin_Ptc11                                      = LlwuPin_11,   ///< Mapped pin PTC11(p56)
   LlwuPin_Ptd0                                       = LlwuPin_12,   ///< Mapped pin PTD0(p57)
   LlwuPin_Ptd2                                       = LlwuPin_13,   ///< Mapped pin PTD2(p59)
   LlwuPin_Ptd4                                       = LlwuPin_14,   ///< Mapped pin PTD4(p61)
   LlwuPin_Ptd6                                       = LlwuPin_15,   ///< Mapped pin PTD6(p63)
...
enum LlwuPeripheral : uint32_t {
   ...
   LlwuPeripheral_ZeroCrossingComparator              = LlwuPeripheral_1, ///< CMP, Analogue Comparator
   LlwuPeripheral_Cmp1                                = LlwuPeripheral_2, 
   LlwuPeripheral_Cmp2                                = LlwuPeripheral_3, 
   LlwuPeripheral_OverCurrentComparator               = LlwuPeripheral_3, ///< CMP, Analogue Comparator
