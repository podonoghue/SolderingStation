...
PORTC->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0001UL);
   }
...
PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0008UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: CMP2_IN1             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
...
///  -------------- | ------------------------------|--------------------------------------------------- | ------------------------- | ----------------------------------------------------
///  PTC0           | IcpDebugLed                   | GPIOC_0                                            | p43                       | CH1_SEL
///  PTD3           | IcpButton                     | GPIOD_3                                            | p60                       | SEL_BTN
///  RESET_b        |                               | RESET_b                                            | p34                       | Reset
///  USB0_DM        | -                             | USB0_DM                                            | p6                        | USBDM
///  USB0_DP        | -                             | USB0_DP                                            | p5                        | USBDP
///  VBAT           | -                             | VBAT                                               | p21                       | Vdd
///  VDDA           | -                             | VDDA                                               | p13                       | Vdd
///  VOUT33         | -                             | VOUT33                                             | p7                        | Vdd
///  VREFH          | -                             | VREFH                                              | p14                       | Vdd
///  VREFL          | -                             | VREFL                                              | p15                       | Vss
///  VREF_OUT       | -                             | VREF_OUT                                           | p17                       | Unused
///  VREGIN         | -                             | VREGIN                                             | p8                        | 5V_Fused
///  VSSA           | -                             | VSSA                                               | p16                       | Vss
///  XTAL32         | -                             | XTAL32                                             | p19                       | Unused
///
///
