...
using HighGainAdcChannel = ADConverter::Channel<3>; // DP3/SE3

/// Low gain ADC channel
using LowGainAdcChanel = ADConverter::Channel<21>;  // DM3/SE21
...
/// Multiplexor selection and bias enable for ADC inputs
...
/// CH1_ID input
using Identify1 = ADConverter::Channel<19>; // ADC_DM0/SE19

/// CH2_ID input
using Identify2 = ADConverter::Channel<0>; // ADC_DP0/SE0
