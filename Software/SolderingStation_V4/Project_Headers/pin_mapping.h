...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: FTM0_CH0             = PTC1 (p44)                     */  { PortCInfo,  GPIOC_BasePtr,  1,       PORT_PCR_MUX(4)|defaultPcrValue  },
         /*   1: FTM0_CH1             = PTC2 (p45)                     */  { PortCInfo,  GPIOC_BasePtr,  2,       PORT_PCR_MUX(4)|defaultPcrValue  },
         /*   2: FTM0_CH2             = PTC3 (p46)                     */  { PortCInfo,  GPIOC_BasePtr,  3,       PORT_PCR_MUX(4)|defaultPcrValue  },
         /*   3: FTM0_CH3             = PTC4 (p49)                     */  { PortCInfo,  GPIOC_BasePtr,  4,       PORT_PCR_MUX(4)|defaultPcrValue  },
...
#define USBDM_FTM1_INFOQUAD_IS_DEFINED
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
            /*   0: FTM1_QD_PHA          = PTB0 (p35)                     */  { PortBInfo,  GPIOB_BasePtr,  0,       PORT_PCR_MUX(6)|defaultPcrValue  },
            /*   1: FTM1_QD_PHB          = PTB1 (p36)                     */  { PortBInfo,  GPIOB_BasePtr,  1,       PORT_PCR_MUX(6)|defaultPcrValue  },
      };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioAddress     gpioBit  PCR value
         /*   0: I2C0_SCL             = PTB2 (p37)                     */  { PortBInfo,  GPIOB_BasePtr,  2,       PORT_PCR_MUX(2)|defaultPcrValue  },
         /*   1: I2C0_SDA             = PTB3 (p38)                     */  { PortBInfo,  GPIOB_BasePtr,  3,       PORT_PCR_MUX(2)|defaultPcrValue  },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   2: --                   = --                             */  { NoPortInfo, 0,         INVALID_PCR,  0 },
         /*   3: LLWU_P3              = PTA4 (p26)                     */  { PortAInfo,  GPIOA_BasePtr,  4,       PORT_PCR_MUX(1)|defaultPcrValue  },
         ...
         /*   9: LLWU_P9              = PTC5 (p50)                     */  { PortCInfo,  GPIOC_BasePtr,  5,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  10: LLWU_P10             = PTC6 (p51)                     */  { PortCInfo,  GPIOC_BasePtr,  6,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  11: LLWU_P11             = PTC11 (p56)                    */  { PortCInfo,  GPIOC_BasePtr,  11,      PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  12: LLWU_P12             = PTD0 (p57)                     */  { PortDInfo,  GPIOD_BasePtr,  0,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  13: LLWU_P13             = PTD2 (p59)                     */  { PortDInfo,  GPIOD_BasePtr,  2,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  14: LLWU_P14             = PTD4 (p61)                     */  { PortDInfo,  GPIOD_BasePtr,  4,       PORT_PCR_MUX(1)|defaultPcrValue  },
         /*  15: LLWU_P15             = PTD6 (p63)                     */  { PortDInfo,  GPIOD_BasePtr,  6,       PORT_PCR_MUX(1)|defaultPcrValue  },
   };
