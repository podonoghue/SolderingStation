...
void mapAllPins() {
      ...
      PORTC->GPCLR = 0x0000UL|PORT_GPCLR_GPWE(0x0087UL);
      PORTC->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0058UL);
      PORTD->GPCLR = 0x0000UL|PORT_GPCLR_GPWE(0x0002UL);
      PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x00FCUL);
}
/** 
