...
public:
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      PORTC->GPCLR = pcrValue|PORT_PCR_MUX(1)|PORT_GPCLR_GPWE(0x0060UL);
   ...
   static void clearPCRs() {
      ...
      PORTC->GPCLR = PORT_PCR_MUX(0)|PORT_GPCLR_GPWE(0x60U);
 ...
 * @{
 */
using Ftm_p34              = const USBDM::Ftm0::Channel<0>;
using Ftm_p35              = const USBDM::Ftm0::Channel<1>;
 ...
 *  ------------------------ | --------------------------------------------|---------------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC0_SE19                          | p8                        | LOW_GAIN_AMP       
 *  ADC0_DP0                 | ADC0_DP0/ADC0_SE0                           | p7                        | HIGH_GAIN_AMP       
 ...
 *  PTA4                     | GPIOA_4/LLWU_P3                             | p21                       | SPARE       
 ...
 *  PTC0                     | GPIOC_0                                     | p33                       | CH1_SEL_LED       
 *  PTC1                     | FTM0_CH0                                    | p34                       | CH1a_DRIVEn       
 *  PTC2                     | FTM0_CH1                                    | p35                       | CH1b_DRIVEn       
 *  PTC3                     | FTM0_CH2                                    | p36                       | CH2a_DRIVEn       
 *  PTC4                     | FTM0_CH3                                    | p37                       | CH2b_DRIVEn       
 *  PTC5                     | GPIOC_5/LLWU_P9                             | p38                       | MUX_EN       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | p39                       | CH2_SEL_LED       
 *  PTC7                     | CMP0_IN1                                    | p40                       | AC_REF       
 *  PTD0                     | GPIOD_0/LLWU_P12                            | p41                       | QUAD_BTN       
 *  PTD1                     | GPIOD_1                                     | p42                       | CH2_BTN       
 *  PTD2                     | GPIOD_2/LLWU_P13                            | p43                       | CH1_BTN       
 *  PTD3                     | GPIOD_3                                     | p44                       | SEL_BTN       
 *  PTD4                     | GPIOD_4/LLWU_P14                            | p45                       | GAIN_ENABLE       
 *  PTD5                     | ADC0_SE6b                                   | p46                       | MUX_SEL0/ID1       
 *  PTD6                     | ADC0_SE7b                                   | p47                       | MUX_SEL1/ID2       
 *  PTD7                     | GPIOD_7                                     | p48                       | BIAS_ENABLE       
 ...
 *  VREFL                    | VREFL                                       | p11                       | Gnd       
 *  VREF_OUT                 | VREF_OUT/CMP1_IN5/CMP0_IN5                  | p13                       | OVERCURRENT       
